...
export class ComparendoService extends BaseService {
...
*/
  public ComparendosConsultar(model: any) {
    return this.apiRequestService.post(this.createCompleteRoute(environment.apiDitra, URLSERVICIO.ComparendosConsultar), model);
  }
}
